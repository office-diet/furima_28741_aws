...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('turbolinks:load', function () {
  if ($('#item_price').length > 0) {
    var _$inputPrice = $('#item_price');
  } else if ($('#price').length > 0) {
    var _$inputPrice2 = $('#price');
  }
...
/******/ });
//# sourceMappingURL=application-b3adcc326309bf43ee5d.js.map